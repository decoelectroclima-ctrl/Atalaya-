...
object WisdomBank {
    ...
    val cards: List<WisdomCard> = listOf(
        ...
        WisdomCard(id = "est_8", framework = SoltarFramework.ESTOICO, title = "FIRMEZA ANTE EL IMPULSO", quote = "«Si alguien te agravia o se aleja, recuerda que el daño solo reside en el juicio que tú hagas de ello.»", author = "Marco Aurelio (Meditaciones)", reflection = "El silencio ajeno no define tu valor. Tu valor se demuestra en cómo te sostienes ante ese silencio."),
        ...
        WisdomCard(id = "cat_1", framework = SoltarFramework.CATOLICO, title = "FE QUE MUEVE MONTAÑAS", quote = "«Si tuvieran fe como un grano de mostaza, dirían a este monte: Pásate de aquí allá, y se pasará; y nada les será imposible.»", author = "Mateo 17:20", reflection = "La fe pequeña es suficiente para grandes cambios."),
        WisdomCard(
            id = "cat_72",
            framework = SoltarFramework.CATOLICO,
            title = "AMOR DE DIOS",
